    ...
    if (($amount)<0)
   {
    ...
    //For 0 (zero) value
         ...
         echo "</script>";
                ...
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                 $sql="insert into transaction(sender,reciever,balance,datetime) values('{$sender}','{$receiver}','{$amount}','$d')";
                $query=mysqli_query($conn,$sql);
 ...
 <div class="container">
   ...
   <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            <!-- Copyright -->
            <div class="text-center p-3" style="background-color: grey;text-align:center;color:white;margin-top:210px;">
                © 2021 Copyright - Made by <strong>Parv Jain</strong> :
